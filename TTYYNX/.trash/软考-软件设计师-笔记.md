...
##### 1.2.1.1. CISC (Complex Instruction Set Computer) 和 RISC (Reduced Instruction Set Computer)
...
##### 7.2.10.5. Abstract Factory（抽象工厂）
...
##### 7.2.12.1. Chain of Responsibility（责任链）
...
##### 7.2.12.10. Template Method（模板方法）
